      ...
      <div class="container">
        ...
        <div class="row justify-content-center" data-aos="fade-up">
          ...
          <div class="col-lg-10">
            ...
            <br>
            <ul>
                <li>Administering the Competition Act of 2002 to prevent practices that adversely affect competition, promote and sustain competition in markets, and to safeguard consumer interests through the Commission established under the Act</li>
                <li>Supervising the three professional bodies, namely the Institute of Chartered Accountants of India (ICAI), Institute of Company Secretaries of India (ICSI), and the Institute of Cost Accountants of India (ICAI), established under the different Acts of Parliament.</li>
                <li>Executing the functions of the Central Government with respect to the administration of Partnership Act, 1932, the Companies (Donations to National Funds) Act, 1951 and the Societies Registration Act, 1980.</li>
                
            </ul><br>
            <h4>Umbrella of Acts</h4>
            <p>MCA governs the following corporate provisions:</p>
            <br>
            <ul>
                ...
                <li>Cost and Works Accountant Act</li>
                <li>Company Secretaries Act, 1980</li>
                <li>Societies Registration Act, 1860</li>
                <li>Companies (Donation to National Fund) Act, 1951</li>
                <li>Accounting Standards and other circulars</li>
            </ul>
          <hr>
