...
<head>
  ...
  <title>Project Finance - Capeeza</title>
          ...
          <div class="col-lg-10">
            ...
            <ul>
              <h4>We have represented clients in connection with numerous types of asset and project financing including:</h4>
                ...
                <li>Equipment finance (including aircrafts and ships)</li>
                <li>Financial markets and banking projects</li>
                 <li>Hospitality</li>
                 <li>Independent power projects</li>
                 <li>Industrial and manufacturing projects</li>
                 <li>Information technology companies</li>
                 <li>LNG projects</li>
                 <li>Oil and gas facilities</li>
                 <li>Sports and entertainment facilities</li>
                 <li>Petrochemical projects</li>
                 <li>Power transmission and distribution projects</li>
                 <li>Renewable energy projects</li>
                 <li>Telecommunications projects</li>
                 <li>Transportation infrastructure (including port facilities, railways, airports and toll roads)</li>
                 <li>Water treatment and desalination projects</li>
            </ul><br>
          <hr>
          </div>
        </div>
